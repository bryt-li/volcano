...
DROP DATABASE IF EXISTS hlhs_activiti;
CREATE DATABASE hlhs_activiti CHARACTER SET utf8;

DROP USER IF EXISTS 'hlhs'@'localhost';
CREATE USER 'hlhs'@'localhost' IDENTIFIED BY 'password@hlhs';
GRANT ALL PRIVILEGES ON hlhs.* TO 'hlhs'@'localhost';
GRANT ALL PRIVILEGES ON hlhs_activiti.* TO 'hlhs'@'localhost';
